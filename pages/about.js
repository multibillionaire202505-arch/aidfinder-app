  ...
  return (
    <>
      ...
      <main style={{ padding: "32px 16px", maxWidth: 880, margin: "0 auto" }}>
        {/* Hero */}
        <section className="fadeItem" style={{ textAlign: "center", marginBottom: 24, ["--i"]: 0 }}>
          <img
            src="/logo.png"
            alt="AidFinder logo"
            width={72}
        ...
        {/* Changing Perception */}
        <section className="card fadeItem" style={{ ["--i"]: 1 }}>
          ...
          <p style={{ margin: 0 }}>
            ...
            and local programs—the real challenge is <strong>finding them</strong>. AidFinder was built to fix that:
            by making programs visible, clear, and accessible to everyone. Our country has extensive social support,
            but people miss out simply because the right information is hard to find. We’re changing that.
          </p>
        </section>

        {/* Mission */}
        <section className="card fadeItem" style={{ ["--i"]: 2 }}>
        ...
        <section className="card fadeItem" style={{ ["--i"]: 3 }}>
          <h3 style={{ marginTop: 0 }}>Multilingual Support</h3>
          <p style={{ margin: 0 }}>
            AidFinder is designed to serve everyone. The app is currently available in{" "}
            <strong>English</strong> 🇺🇸, <strong>Spanish</strong> 🇪🇸, and <strong>French</strong> 🇫🇷, with more
            languages planned. Access to help should not depend on the language you speak.
          </p>
        </section>

        {/* What we offer */}
        <section className="card fadeItem" style={{ ["--i"]: 4 }}>
        ...
        {/* Values */}
        <section className="card fadeItem" style={{ ["--i"]: 5 }}>
        ...
        {/* Contact */}
        <section className="card fadeItem" style={{ ["--i"]: 6 }}>
      ...
      {/* Page-scoped minimal styles + animation */}
      <style jsx>{`
        .card {
          padding: 16px;
