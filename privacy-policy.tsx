// File: pages/legal/privacy-policy.tsx
// @ts-nocheck
...
export default function PrivacyPolicy() {
  ...
  return (
    <main style={{ maxWidth: 720, margin: "40px auto", padding: 16, lineHeight: 1.6 }}>
      ...
      <h2>1) Who We Are</h2>
      <p>
        AidFinder (“AidFinder,” “we,” “us,” or “our”) helps people discover assistance
        resources across Food, Health, Housing, Financial, and Education categories.
        This Privacy Policy explains how we handle information when you use our web or
      ...
      <p>
        AidFinder is not directed to children under 13, and we do not knowingly collect
